...
func NewLoginPage(p *rod.Page) *LoginPage {
	return &LoginPage{page: p}
}
...
func (lp *LoginPage) Submit() (err error) {
	...
	if err = lp.checkLoginError(); err != nil {
		return
	}
...
func (lp *LoginPage) checkLoginError() error {
	elements, err := lp.page.Elements(".alert-danger")
	if err != nil {
...
func (lp *LoginPage) handleVerificationStep() error {
	...
	if err := lp.page.Keyboard.Press(input.Enter); err != nil {
